...
class Cat:
    ...
    * Implement private methods _increase_saturation_level and
     _reduce_saturation_level that will receive value and add/subtract from
      saturation_level this value
    ...
    * Implement method run it receives hours value
      ...
      Than if your cat run less or eq than 25 _reduce_saturation_level
       with value 2
      ...
      return text like this: f"Your cat ran {run_km} kilometers"
    ...
    * Implement get_average_speed and return average_speed
    ...
    products = {'fodder': 10, 'apple': 5, 'milk': 2, 'another_food': 0}
...
class Cheetah(Cat):
    ...
    * Redefine method _set_average_speed
    ...
    products = {'gazelle': 30, 'rabbit': 15, 'another_food': 0}
...
class Wall:
    ...
    * Implement method number_of_rolls_of_wallpaper which receives such
     parameters: roll_width_m, roll_length_m
      (_m in the parameters name means meters) return number of rolls
       of wallpaper

      Example:
          count of lines in roll eq roll length in meters divide height of
           the wall (use rounding down)
...
class Door:
     ...
     * Implement method door_square which receives material value as
      a parameter
     ...
     *  Implement method update_wood_price which receives new_price value and
      updates your old price

     *  Implement method update_metal_price which receives new_price value and
      updates your old price
...
class House:
    ...
    * Implement method create_window which will create new window using
     class Window and add it to the __windows list
      it receives parameters width and height
      if width or height eq 0 raise ValueError "Value must be not 0"
    ...
    * Implement method get_door_price that receives material value and
    returns price of the door
    ...
    * Implement method get_number_of_rolls_of_wallpapers that returns sum of
     the number of rolls of wallpapers needed for all our walls
      it receives roll_width_m, roll_length_m parameters
      Check if roll_width_m or roll_length_m eq 0 raise ValueError
      "Sorry length must be not 0"
    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def create_roof(self, width, height, roof_type):
        ...
        if self.__roof is None:
            ...
            ValueError("The house can not have two roofs")
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        ...
        return sum([wall.number_of_rolls_of_wallpaper(
            roll_width_m, roll_length_m) for wall in self.__walls])

    def get_room_square(self):
        return self.get_walls_square() - sum(
            [window.window_square() for window in self.__windows],
